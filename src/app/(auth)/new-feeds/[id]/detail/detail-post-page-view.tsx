...
import { PostDetailForCard } from '@/src/app/api/services/postService';
  ...
  return (
    <div className="card">
      ...
      <Fieldset legend="Nội dung bài viết" className="flex flex-column" toggleable>
        <div>{props.detailPost.content_text}</div>
      ...
      <Fieldset legend="Thông tin tài khoản" toggleable>
        <p>Tên tài khoản: {props.detailPost.account.name}</p>
        <p>nickname: {props.detailPost.account.nick_name}</p>
        <p>ảnh đại diện: </p>
